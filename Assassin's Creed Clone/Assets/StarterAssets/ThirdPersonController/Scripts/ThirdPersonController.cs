...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private int wallRide;
        private int wallRideReset = 2;

        public GameObject WallRideTarget;
        public GameObject LedgeClimbTarget;
        ...
        private void JumpAndGravity()
        {
            ...
            else
            {
                ...
                if (Keyboard.current.spaceKey.isPressed && _verticalVelocity <= 0.0f && wallRide > 0)
                {
                    if (Physics.Raycast(WallRideTarget.transform.position, WallRideTarget.transform.forward, out wallRay, 1f))
                    {
                        // the square root of H * -2 * G = how much velocity needed to reach desired height
                ...
                else if (Keyboard.current.spaceKey.isPressed && wallRide == 0 && 
